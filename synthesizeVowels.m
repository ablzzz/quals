function vowelWav = synthesizeVowels(vowelID, flag)
    ...
    if flag == 1; %%% Synthesize only one instance %%%%
        ...
        for j = 1 : 20;
            ...
            R =  R + randVal.*dr;  
            vowelWav = synthesizeVowelInstance(formants, R);
            outFile = ['vowel_' num2str(vowelID) '_instance_' num2str(j) '_f1_' num2str(floor(formants(1))) '_f2_' num2str(floor(formants(2))) ...
